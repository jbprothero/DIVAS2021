function [outMap, keyIdxMap, anglesMap, jointBlockOrder] = DJIVEJointStrucEstimateJPLoadInfo(...
    VBars, UBars, phiBars, psiBars, rBars, datablock, dataname, theta0, optArgin, iprint, figdir)
...
%   Copyright (c)  Meilei Jiang 2018
    ...
    for len = nb:-1:1
        ...
        for i = 1:nlen
            ...
            [Vi, curRanks, angles] = BlockJointStrucEstimateJPLoadInfo(blockIn, datablock, dataname, ...
