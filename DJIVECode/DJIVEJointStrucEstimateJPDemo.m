function [outMap, keyIdxMap, anglesMap, jointBlockOrder] = DJIVEJointStrucEstimateJPDemo(...
    VBars, UBars, phiBars, psiBars, rBars, datablock, dataname, theta0, optArgin, iprint, figdir, rowSpaces)
...
%   Copyright (c)  Meilei Jiang 2018
    ...
    for len = nb:-1:1
        ...
        for i = 1:nlen
            ...
            [Vi, curRanks, angles] = BlockJointStrucEstimateJPDemo(blockIn, datablock, dataname, ...
                VBars, UBars, phiBars, psiBars, rBars, curRanks, outMap, theta0, optArgin, ...
                iprint, figdir, rowSpaces);
            if size(Vi, 2) > 0
                t = Idx2numMJ(blockIn);
                outMap(num2str(t)) = Vi;
