function [Vi, curRanks, angles] = BlockJointStrucEstimateJPDemo(blockIn, datablock, dataname, ...
...
%   Copyright (c)  Meilei Jiang 2018
    ...
    while searchNext
        ...
        figname = strjoin({strjoin(blockName, '-'), '-joint-optV', ...
            num2str(j)}, '');
        ccpOutVisualMJDemo(angleHats, phiBars, dataname, iprint, figdir, figname, angleTrues);
        for ib = 1:nb
